...
import com.books.server.config.audit.AuditEventConverter;
import com.books.server.domain.PersistentAuditEvent;
...
import static com.books.server.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
