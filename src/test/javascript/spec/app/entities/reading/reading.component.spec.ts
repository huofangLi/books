...
import { ReadingComponent } from 'app/entities/reading/reading.component';
import { ReadingService } from 'app/entities/reading/reading.service';
import { Reading } from 'app/shared/model/reading.model';

describe('Component Tests', () => {
  describe('Reading Management Component', () => {
    let comp: ReadingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReadingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.readings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
