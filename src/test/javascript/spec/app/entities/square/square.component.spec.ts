  ...
  describe('Square Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SquareComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.squares[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
