...
import { BookSummaryComponent } from 'app/entities/book-summary/book-summary.component';
...
describe('Component Tests', () => {
  describe('BookSummary Management Component', () => {
    let comp: BookSummaryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BookSummaryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookSummaries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
