...
/**
 * REST controller for managing {@link com.books.server.domain.Topic}.
 */
@RestController
@RequestMapping("/api")
public class TopicResource {
     ...
     */
    @GetMapping("/topics")
    public ResponseEntity<List<Topic>> getAllTopics(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
